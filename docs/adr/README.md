...
| [0007](0007-participant-accounts.md) | Participant accounts identity | Accepted | Model Guardian (account) ↔ Participant (attendee) first-class, with `relation='self'` for adults; RLS via `can_act_for_participant()`. |
